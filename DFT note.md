...
1. **H-K First Theorem**: For a given electron density \( n(r) \), there exists a unique corresponding external potential \( V_{\text{ext}}(r) \) and ground-state total energy \( E \). Thus, the ground-state energy of the Schrödinger equation can be expressed in terms of the electron density.
